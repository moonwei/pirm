<div class="container">
<?php
$this->session->post_name = $posts->name;
$this->session->post_id = $posts->sn;
?>
<h3>
<a href="<?php echo site_url("pcinfo/departs/"); ?>"><?php echo $this->session->depart_name; ?></a> -
<a href=<?php echo site_url("pcinfo/postInDep/" . $posts->dep); ?> ><?php echo $posts->name . '( ' . $posts->sn . ' )'; ?></a>
</h3>
如果需要修改部门和岗位，请点击上面的部门或岗位重新选择。

    <form class="form-horizontal" name="form1" method="POST" action="<?php echo site_url("pcinfo/add2/"); ?>" onsubmit="return checkform(this)">
        <div class="container">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		pcinfo.did = "<?php echo $posts->dep; ?>";
		pcinfo.dep = "<?php echo $this->session->depart_name; ?>";
		pcinfo.post_id = "<?php echo $posts->sn; ?>";
		pcinfo.post_name = "<?php echo $posts->name; ?>";
    ...
    function checkform(theForm) {
        ...
        if (form1.sy_phone.value == "") {
            ...
            pcinfo.sy_bm="<?php echo $posts->dep; ?>";
